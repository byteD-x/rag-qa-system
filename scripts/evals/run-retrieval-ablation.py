...
def main() -> int:
    ...
    parser.add_argument("--fixture", default="tests/evals/retrieval-ablation-fixture.json")
    parser.add_argument("--output", default="docs/reports/retrieval_ablation_report.json")
    parser.add_argument("--summary-output", default="docs/reports/retrieval_ablation_report.md")
