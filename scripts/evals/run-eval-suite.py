...
EVAL_LONG_RAG_PATH = REPO_ROOT / "scripts/evals/eval-long-rag.py"
...
def main() -> int:
    ...
    parser.add_argument("--config", default="tests/evals/suite.sample.json")
    parser.add_argument("--output", default="docs/reports/eval_suite_report.json")
    parser.add_argument("--summary-output", default="docs/reports/eval_suite_report.md")
