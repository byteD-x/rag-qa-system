...
def main() -> int:
    ...
    parser.add_argument("--corpus-id", action="append", default=[], help="repeatable; format kb:<uuid> or novel:<uuid>")
    parser.add_argument("--document-id", action="append", default=[])
    parser.add_argument("--output", default="docs/reports/long_rag_eval_report.json")
    parser.add_argument("--summary-output", default="docs/reports/long_rag_eval_report.md")
