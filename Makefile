...
.PHONY: help doctor preflight init up down logs logs-follow export-logs ci test build encoding smoke-eval demo-offline job-readiness job-evidence
...
help:
	...
	@echo   make demo-offline - 无 Docker 生成岗位演示证据链
