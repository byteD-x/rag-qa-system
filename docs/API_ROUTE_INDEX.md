...
| api-gateway | `POST` | `/api/knowledge_base/batch-ingest` | `proxy_knowledge_batch_ingest` | `apps/services/api-gateway/src/app/gateway_admin_routes.py:109` |
...
| api-gateway | `DELETE, GET, OPTIONS, PATCH, POST, PUT` | `/api/v1/kb/{path:path}` | `proxy_kb` | `apps/services/api-gateway/src/app/gateway_admin_routes.py:118` |
