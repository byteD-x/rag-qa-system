...
```powershell
$targets = python scripts/quality/select_fast_tests.py --staged --fallback tests
powershell -File scripts/quality/ci-check.ps1 -SkipFrontendBuild -SkipFrontendUnitTests -SkipDockerConfig -PytestHeartbeatSeconds 20 -PytestTargets $targets
```
